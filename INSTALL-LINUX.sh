...
printf '\nMCP Control Hub - Linux installer\n'
...
printf 'If PyAutoGUI cannot capture or control the screen under Wayland, use the compositor permissions or an X11 session.\n'
